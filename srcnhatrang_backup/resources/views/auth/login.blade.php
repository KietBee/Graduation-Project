...
<section class="min-h-screen flex items-stretch text-white ">
    <div class="xl:flex xl:w-1/2 down_xl:hidden relative items-center">
    ...
    <div class="xl:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: #161616;">
        ...
        <div class="w-full py-6 z-20">
            <h1 class="mb-25">
                <a id="header-logo" class="inline-flex" href="/">
                    <img src="{{ $header['logoHeader']['url'] }}" alt="{{ $header['logoHeader']['alt'] }}" width="80" height="80" />
                </a>
            </h1>
            <form method="POST" action="{{ route('login') }}" class="form-control-outline sm:w-2/3 w-full px-4 xl:px-0 mx-auto">
                @csrf
                <!-- Email Address -->
                ...
                <!-- Remember Me -->
                <div class="flex">
                    <div class="block mt-4 w-1/2 text-left">
                        <label for="remember_me" class="inline-flex items-center">
                            <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="remember">
                            <span class="ms-2 text-sm text-gray-600">{{ __('Ghi nhớ đăng nhập') }}</span>
                        </label>
                    </div>
                    <div class="text-right text-gray-400 w-1/2 hover:underline hover:text-gray-100">
                        <a href="{{ route('password.request') }}">Quên mật khẩu?</a>
                    </div>
                </div>
                <div class="px-4 pb-2 pt-4">
                    <button class="uppercase block w-full p-4 text-xl rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none">sign in</button>
                </div>

                <p class="text-sm mt-6 text-center">Bạn chưa có tài khoản? <a href="{{ route('register') }}" class="text-blue-600 font-semibold hover:underline ml-1">Đăng ký ngay</a></p>

                <div class="p-4 text-center right-0 left-0 flex justify-center space-x-4 mt-16 xl:hidden ">
                    <a href="#">
                        <svg fill="#fff" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/></svg>
                    </a>
                    <a href="#">
