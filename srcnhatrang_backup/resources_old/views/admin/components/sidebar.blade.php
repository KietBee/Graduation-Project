<div id="sidebar" class="fixed -left-[280px] w-[280px] h-full z-70 xl:w-20p xl:left-0 xl:relative  bg-gray-900">
  <div class="flex justify-between p-6 items-center space-x-3 container">
    ...
    <button aria-label="close" id="close-sidebar" class="xl:hidden focus:outline-none focus:ring-2">
  ...
  <div class="flex flex-col justify-start items-center px-6 border-b border-gray-600 w-full">
    <button type="button" aria-label="open dropdown menu 1" aria-expanded="false" aria-controls="dropdown-menu-1" class="main-opiton has-sub focus:outline-none focus:text-indigo-400 text-left  text-white flex justify-between items-center w-full py-5 space-x-14  ">
      <p class="text-sm leading-5  uppercase">Profile Overview</p>
      <span class="icomoon icon-chevron-down block"></span>
    </button>
    <div id="dropdown-menu-1" class="flex justify-start  flex-col w-full items-start pb-1 ">
...
{{-- <script>
  $(document).ready(function(){
    ...
    function showSidebar() {
      $('#slideBar').removeClass('down_xl:hidden').addClass('xl:w-20p');
    }

    // Function to hide sidebar
    function hideSidebar() {
      $('#slideBar').removeClass('xl:w-20p').addClass('down_xl:hidden');
    }
...
{{-- <script>
  $(document).ready(function(){
    ...
    // Function to hide sidebar when close button is clicked
